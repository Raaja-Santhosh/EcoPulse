  ...
  return (
    <div className="flex flex-col gap-6 text-left max-w-4xl mx-auto" role="tabpanel" aria-label="Pluggable GenAI Assistant">
      ...
      <div className="neo-card bg-white border-2 border-[#2b3a34] shadow-[4px_4px_0px_#2b3a34] flex flex-col h-[500px] p-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-4" aria-live="polite" aria-label="Chat message history" role="log">
          {messages.map((msg) => (
            <div
              key={msg.id}
          ...
          {isLoading && (
            <div className="self-start bg-[#f5f3eb] border-2 border-[#2b3a34] p-3 shadow-[2px_2px_0px_#2b3a34] flex items-center gap-1" role="status" aria-label="Assistant is typing">
        ...
        <form onSubmit={handleFormSubmit} className="flex border-t-2 border-[#2b3a34] p-3 bg-white" aria-label="Send a message to the EcoPulse assistant">
          <input
            type="text"
            ...
            aria-label="Type your message to the eco-assistant"
          />
          <button
            type="submit"
